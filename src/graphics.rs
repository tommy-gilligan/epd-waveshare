...
mod tests {
    ...
    fn graphics_new() {
        ...
        display.set_pixel(Pixel(Point::new(1, 0), TriColor::White));
        ...
        assert_eq!(bw_buffer, [64, 0]);
        assert_eq!(chromatic_buffer, [64, 0]);

        display.set_pixel(Pixel(Point::new(0, 0), TriColor::Chromatic));
        ...
        assert_eq!(bw_buffer, [64, 0]);
        assert_eq!(chromatic_buffer, [192, 0]);
    }
}
